 ...
 * @LastEditTime: 2024-05-08 10:29:35
 * @FilePath: /cooking-menu/src/views/staples/bun/index.vue
...
<script lang="ts" setup>
  ...
  const tableData = ref([]);
  tableData.value = bunFoodsList;
  // console.log('tableData', bunFoodsList);
