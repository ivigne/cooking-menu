 ...
 * @FilePath: /cooking-menu/src/views/asia/eastAsia/china/mockData/henanProvince/jiaozuo.ts
 * @Description:
 *
...
export const jiaozuoFoodsList = [
  // 怀府闹汤驴肉，相传明清时期，沁阳百姓对驴肉进行加工时，会定量在“老汤”内按比例加入深井水，再精心选择30余种调料经过特殊工艺加工，最后做出的驴肉
  {
    province: '河南省',
    city: '焦作市',
    district: '',
