 ...
 * @LastEditTime: 2025-02-20 15:29:50
...
// );
// console.log(
//   '--------  xiangtanFoodsList菜单： ' + xiangtanFoodsList.map((item) => item['foodName']),
// );
...
// console.log(
//   '--------  chenzhouFoodsList菜单： ' + chenzhouFoodsList.map((item) => item['foodName']),
// );
