 ...
 * 天津-天津市-特产美食
 * 
 * 曹记驴肉、冠生园八珍羊腿、陆记烫面炸糕、白记水饺、芝兰斋糕干、大福来锅巴菜、石头门坎素包、
 * 糖炒栗子、明顺斋什锦烧饼、羊汤、上岗子面茶、王记麻花（又称馓子麻花）、豆香斋牛肉香圈、豆皮卷圈、白记水饺、水爆肚、煎焖子、花样馃子、怪味果仁、石头门坎素包、罗汉肚、熟梨糕、皮糖张、北塘海鲜等。
狗不理包子、十八街麻花、耳朵眼炸糕、
糖礅、熟梨糕、茶汤儿、果仁张、崩豆张、面茶、杨村糕干、
煎饼馃子、锅巴菜、老豆腐、果子、烫面炸糕、卷圈、荷包蛋、糖果子、果篦儿。
