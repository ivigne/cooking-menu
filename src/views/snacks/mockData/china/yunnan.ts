/**
 * 云南小吃
 * 酸角糕：酸角糕以天然酸角为原料，运用独特的保色护香工艺精制而成云南特产。
 * 不含防腐剂、香精、甜味素及色素等添加剂，保留了原果原有的风味而又不破坏原果的营养价值。
 * 酸甜味道符合大众口味，能促进肠胃消化，去除口气，可也清暑热，化积滞，治暑热食欲不振，妊娠呕吐，小儿疳积，治酒化为痰，解酒护肝，补钙。
 * 烧饵块：“烧饵块”是云南当地的一种民俗小吃。是用煮熟的大米饭压成块状，通常是圆形薄饼状。在炭火上面烤制，然后涂上酱料和菜陷即可。
 * 做法与糍粑相同。但糍粑的原料是糯米，饵块的原料是大米。过桥米线：过桥米线是云南滇南地区特有的小吃，属滇菜系。过桥米线起源于蒙自地区。
 * 过桥米线汤是用大骨、老母鸡、云南宣威火腿经长时间熬煮而成的， 所属菜系滇菜。
 * 过桥米线由四部分组成：一是汤料覆盖有一层滚油；二是佐料，有油辣子、味精、胡椒、盐；
 * 三是主料，有生的猪里脊肉片、鸡脯肉片、乌鱼片，以及用水过五成熟的猪腰片、肚头片、水发鱿鱼片；
 * 辅料有来过的豌豆尖、韭菜，以及芫荽、葱丝、草芽丝、姜丝、玉兰片、氽过的豆腐皮；
