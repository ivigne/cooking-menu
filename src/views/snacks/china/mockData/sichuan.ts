/**
 * 四川小吃
 * 成都小吃：双流老妈兔头、韩包子、甜水面、伤心凉粉、军屯锅盔、
 * 蛋烘糕、玻璃烧麦、担担面、鸡丝凉面、宜宾燃面、灯影牛肉、火鞭子牛肉、小笼粉蒸牛肉、钵钵鸡、肥肠粉、川味凉面、川北凉粉、
 * 冰粉、伤心凉粉、赖汤圆、龙抄手、钟水饺、藤椒抄手、祥和祥小吃、三大炮、夫妻肺片、串串香、麻辣烫、绵阳米粉、
 * 广元蒸凉面、罗江豆鸡、奶汤面、炖鸡面、梓潼酥饼、鱼皮花生、白橙糖、鳝鱼鸡蛋卷、渣渣面等
 *  * 呙凉粉
呙凉粉是遂宁街头最为常见的特色小吃，呙凉粉种类很多，有红薯凉粉、豌豆凉粉、玉米凉粉、米凉粉等，一碗凉粉会使用十多种的调料，麻油、香醋、辣椒、大蒜汁、细盐等，其中小米辣的威力都足以让人吃得潸然泪下，口感Q弹，麻辣鲜香，开胃可口，特别好吃。
蓬溪姜糕
蓬溪姜糕，不仅是一种特色美食，更是对传统美味的传承。选用去病健身的药物作为食材，合制成糕，历史很悠久，包装很简陋，价格很便宜；味道么，有点像合川桃片，只是不像合川桃片里面有花生核桃之类的，也就一个口味，有点甜但不腻，超级美味！
 * 蓬溪熨斗糕
熨斗糕，是四川遂宁蓬溪地方的特色小吃。分甜咸两个口味，米浆加入鸡蛋白、熟猪油搅拌成糕浆，倒入烙碗待金黄，用那细铁签沿糕边划松，放入纸袋，香味飘远，一口咬下：绝了。
 * 自贡小吃
 * 豆腐脑水粉、开花白糕、卤肉香包、燕窝丝、贡井徐氏油茶酥锅盔、咖喱鸡面、白蜂糕、人参果、坛子饼、
 * 贡井牛栏湾五香豆腐干、刷把头、黄三婆叶儿粑、豌豆粑、绿豆粑、谢家黄凉粉、贡井黄绍荣蜘蛛粑、张家沱鸡婆头、糍粑坳咸糍粑、流水沟空心面、荣县腹油包子、
 * 油炸粑、四喜汤圆、俄罗酥、敦教糕等。
 */
