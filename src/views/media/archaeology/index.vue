 ...
 * @LastEditTime: 2023-11-17 19:02:52
 * @FilePath: /cooking-menu/src/views/media/archaeology/index.vue
...
<script lang="ts" setup>
  ...
  import { archaeologyFoodsList } from './data';
  ...
  const { t } = useI18n();
  console.log('tableData', archaeologyFoodsList);
  // const { createConfirm, createMessage } = useMessage();

  const [registerTable] = useTable({
    dataSource: archaeologyFoodsList,
