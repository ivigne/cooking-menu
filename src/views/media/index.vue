 ...
 * @FilePath: /cooking-menu/src/views/snacks/index.vue
...
<script lang="ts" setup>
  ...
  import { snacksFoodsList } from './mockData/index';
  ...
  const { t } = useI18n();
  console.log('tableData', snacksFoodsList);
  // const { createConfirm, createMessage } = useMessage();

  const [registerTable] = useTable({
    dataSource: snacksFoodsList,
