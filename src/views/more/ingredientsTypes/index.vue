 ...
 * @Date: 2023-11-15 17:18:11
 * @FilePath: /cooking-menu/src/views/more/ingredientsTypes/index.vue
 * @Description: 
 * 
 ...
 * @FilePath: /cooking-menu/src/views/ingredientsTypes/index.vue
...
<script lang="ts" setup>
  ...
  import { ingredientsTypesFoodsList } from './ingredientsTypes';
  ...
  const { t } = useI18n();
  console.log('tableData', ingredientsTypesFoodsList);
  // const { createConfirm, createMessage } = useMessage();

  const [registerTable] = useTable({
    dataSource: ingredientsTypesFoodsList,
